...
Replace this section with the supported versions for `contextpin`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `contextpin` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in contextpin.
